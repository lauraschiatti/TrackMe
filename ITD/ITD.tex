...
\section{D4H Backend (Spark project)}
	The general structure of the project can be seen in Figure . It has xx main parts, which are.
	
	\begin{figure}[H]
		\centering
		\includegraphics[scale=1]{images/backend/d4h_source_code_structure.png}
		\caption[Source code: General Structure]{Source code: General Structure}
		\label{fig:d4h_source_code_structure}
	\end{figure}
	
	It is important to highlight four important folders, which are
	\begin{itemize}
		\item model
		\item resources
		\item services
...
The whole project is contained in the folder src (Figure \ref{fig:d4h_source_code_structure}). In this folder we can distinguish three main parts: app, assets and environment. Outside of them there are other configuration files

	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{images/frontend/d4h_source_code_structure.png}
		\caption[Source code: General Structure]{Source code: General Structure}
		\label{fig:d4h_source_code_structure}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{images/frontend/d4h_source_code_models_services.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{images/frontend/d4h_source_code_components_assets.png}
