...
%	\thispagestyle{empty}
	...
	It is important to keep track of the revisions made to this document, mainly because it helps to see exactly what changes have been made and focus only on them: \\
	...
	\textit{(a) }In order to be more precise regarding the architectural design of the system and looking forward to make a correct implementation, some modifications to this document are needed. All of them are related to use cases, requirements traceability matrix and user interfaces.
	...
	\begin{itemize}
		...
		\begin{enumerate}
			\item{The Third party company clicks on the View data button}
			\item{The system shows a form with different filter criteria, which contains location, age range, gender and blood type fields}
