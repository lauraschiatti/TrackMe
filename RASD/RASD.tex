...
%	\thispagestyle{empty}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Home_Page.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Login.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Register.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Register_third_party.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Dashboard_individual.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Individual_Request.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/Make_Request.png}\caption[UI: Third party user's Dashboard to make requests]{Third party user's Dashboard to make requests}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/organizer_dashboard_1.png}\caption[UI: Organizer's Dashboard - create new run]{Organizer's Dashboard- create new run}
	...
	In the Figure \ref{fig:organizer_dashboard_1}, from point(9) - organizer can see the number of pending invites for the already configured runs which are still pending to send to the targeted participants; point(10) - organizer's are able to view the number of already configured runs from the past; point(11) - they can start configuring a new run by clicking on 'Create new run' button.
	 ...
	 \begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/organizer_dashboard_2.png}\caption[UI: Organizer's Dashboard - Define running circuit]{Organizer's Dashboard- Define running circuit}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/t4r_list_of_available_run.png}\caption[UI: Spectators' view List of available run]{Spectators' view List of available run}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/spectators_valid_race.png}\caption[UI: Spectators' view during the race]{Spectators' view during the race}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{Diagrams/spectators_invalid_race.png}\caption[UI: Spectators' view when race has ended]{Spectators' view when race has ended}
