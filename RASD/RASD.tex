...
\item{\textbf{Third party company}}: Customer who needs to know the health status of the population for different purposes (e.d. health insurance companies)
...
\begin{itemize}
\item i.e.: stands for id est and means “in other words.” 
\item e.g.: stands for exempli gratia and means “for example.”
\item $[Gn]$: n-goal. 
...
\caption[Product Perspective as Class Diagram]{Product Perspective as Class Diagram}
    ...
    \textbf{Entry conditions}: - \\
  	\textbf{Event flow}:
  		\begin{enumerate}
    			...
    			\item{The system \textbf{Sends a Data4Help request} (\usecase{15})}
  		\end{enumerate}
  	\textbf{Exit conditions}:
  		\begin{enumerate}
    ...
    \textbf{Entry conditions}: 
  	...
  	\textbf{Event flow}:
  		\begin{enumerate}
    			...
    			\item{The Participant clicks either on \textbf{Accept invitation} (\usecase{17}) or \textbf{Reject invitation} (\usecase{18})}
  		\end{enumerate}
  	\textbf{Exit conditions}:
  		\begin{enumerate}
    ...
    \textbf{Entry conditions}: 
  	...
  	\textbf{Event flow}:
  		\begin{enumerate}
    			...
    			\item{The system \textbf{Enrolls the participant into the run} (\usecase{19})}
    			\item{The system shows all the run invitations to the user}
  		\end{enumerate}
  	\textbf{Exit conditions}:
  		\begin{enumerate}
    ...
    \textbf{Entry conditions}: 
  	...
  	\textbf{Event flow}:
  		\begin{enumerate}
    			...
    			\item{The system shows the \textbf{Define running circuit} (\usecase{21}) web page}
  		\end{enumerate}
  	\textbf{Exit conditions}:
  		\begin{enumerate}
...
Individual or a Third party company
